...
export const Chat = ({ room, name, imageURL, setIsInChat }) => {
  ...
  return (
    <div className="chat-app" style={{ padding: '15px 40px 120px 40px' }}>
      <div className="header">
        <h1 class="text-center pb-3 text-info">Welcome to Room : {room.toUpperCase()}</h1>
      </div>
      ...
      <div className="input-fix bg-light">
        <form onSubmit={handleSubmit} className="new-message-form">
          <div class="flex-grow-0 py-3 px-4 border-top">
            ...
            <div class="input-group">
              <span class="input-group-text">Room : {room.toUpperCase()}</span>
              <input type="text"
                value={newMessage}
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
          ...
          <button class="btn btn-outline-danger" type="submit" onClick={handleSignOutClick}>Destroy the chat</button>
        </div>
